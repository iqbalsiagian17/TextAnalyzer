...
def urutkan_kata(artikel):
    ...
    kata_list = artikel_bersih.lower().split()
...
def main():
    while True:
        ...
        print("3. Urutkan Kata Berdasarkan Abjad")
        print("4. Keluar")
        pilihan = input("Pilih menu (1-4): ")

        if pilihan == "1":
            kata = input("Masukkan kata yang dicari: ")
            jumlah = hitung_kata(artikel, kata)
            ...
            print("\n=== Artikel Setelah Diganti ===")
            print(artikel_baru)

        elif pilihan == "3":
            kata_terurut = urutkan_kata(artikel)
            print("\n=== Daftar Kata Terurut ===")
            print(kata_terurut)
